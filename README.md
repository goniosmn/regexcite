...
[![R-CMD-check](https://github.com/goniosmn/regexcite/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/goniosmn/regexcite/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
devtools::install_github("goniosmn/regexcite")
```
